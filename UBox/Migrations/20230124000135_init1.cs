        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserDetailInfoId = table.Column<int>(nullable: true),
                    UserDetailInfoId1 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.UserDetailInfoId,
                        principalTable: "UserDetailInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FollowArrays_UserDetailInfos_UserDetailInfoId1",
                        column: x => x.UserDetailInfoId1,
                        principalTable: "UserDetailInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
