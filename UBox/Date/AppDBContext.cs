...
namespace UBox.Date
{
    public class AppDBContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelbuilder)
        {
            ...
            //Налаштування связки в таблиці UserDetailInfo містить всі звязки для User
            ...
            //Налаштування связки в таблиці FollowArray містить хто і на кого підписаний
            ...
            //Налаштування зв'язки таблиц Like таблиці яка зберігає пости викладени користувачем
